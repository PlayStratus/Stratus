...
- Saves the timestamp of the captured audio frames
...
- Sends the encoded audio frames, frame size, and timestamp to transport via a common mailbox for the client to consume (not implemented yet)
