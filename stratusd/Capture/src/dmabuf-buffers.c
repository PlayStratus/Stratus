...
const struct message_handler dmabuf_buffers_message_handlers[] = {
    ...
    /*
    { "zwp_linux_dmabuf_v1",           "get_default_feedback",   &zwp_linux_dmabuf_get_default_feedback },
    { "zwp_linux_dmabuf_feedback_v1",  "format_table",           &zwp_linux_dmabuf_feedback_format_table },
    { "zwp_linux_dmabuf_feedback_v1",  "tranche_formats",        &zwp_linux_dmabuf_feedback_tranche_formats },
