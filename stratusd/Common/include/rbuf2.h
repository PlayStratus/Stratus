 ...
 * result, the producer MUST register a "free" function that will run (in the
 * consumer thread) when rbuf_pop is called. Additionally, the following
 ...
 * - The consumer must not call rbuf_push
